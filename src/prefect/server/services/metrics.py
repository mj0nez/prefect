...
class MetricsCollector(LoopService):
    """
    A loop service that collects metrics.
    """

    def __init__(self, loop_seconds: float = None, **kwargs):
        super().__init__(
            loop_seconds=(loop_seconds or PREFECT_METRICS_SAMPLE_RATE.value()),
            **kwargs,
        )
